...
try:
    ...
    if postResponse.status and 'NewID' in postResponse.results[0]:
        ...
        getList.props = [
            "ID", "PartnerKey", "CreatedDate", "ModifiedDate", "Client.ID",
            "Client.PartnerClientKey", "ListName", "Description", "Category",
            "Type", "CustomerKey", "ListClassification", "AutomatedEmail.ID"
        ]
        ...
        patchSub.props = {
            "ID": newListID,
            "Description": "I updated the description"
        }
